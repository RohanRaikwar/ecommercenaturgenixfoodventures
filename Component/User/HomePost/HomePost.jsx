...
function HomePost({ layout }) {
    const { sectionfour, sectionone, sectiontwo, sectionthree, sliderTwo, banner } = layout || {};

    console.log("sectionone tie", sectionone, sectiontwo);

    const { setQuickVw, QuickVw, setUserLogged, setLoginModal, setCartTotal } = useContext(ContentControl);
                                                ...
                                                <Link href={`/c/${obj.slug}`} className="LinkTagNonDec">
                                                    <div className={style.UserCateSlidImgDiv}>
                                                        <img
                                                            ...
                                                            src="http://localhost:5000/uploads/product/1722430517392.9491722430592984.8037/1722430517392.949bg.jpg"
                                                            alt={obj.name}
                                                            loading="lazy"
                                                        />
                                                    </div>
                                                    <div>
                                                        <h5
                                                            ...
                                                            className='UserBlackMain font-bolder oneLineTxt'
                                                        >
                                                            {obj.name}
                                                        </h5>
                                                    </div>
                                        ...
                                        <div className={style.UserMainProCard}>
                                            <div className={style.UserMainProimgDiv + ' text-center'}>
                                                ...
                                                <Link href={`/p/${obj.slug}/${obj._id}`} className="LinkTagNonDec">
                                                    <img
                                                        src="http://localhost:5000/uploads/product/1722498498449.9581722498568733.981/1722498498449.958sliderr.jpg"
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        Server.get('/users/product/' + obj.slug + '/' + obj._id)
                                                            .then(item => {
                                                                setQuickVw({
                                                                    ...QuickVw,
                                                                    active: true,
                                    ...
                                    <SwiperSlide key={key}>
                                        <div className={style.UserMainProCard}>
                                            <div className={style.UserMainProimgDiv + ' text-center'}>
                                                ...
                                                <Link href={`/p/${obj.slug}/${obj._id}`} className="LinkTagNonDec">
                                                    <img
                                                        src="http://localhost:5000/uploads/banner/1722430517392.9491722430592984.8037/1722430517392.949bg.jpg"
                                                        loading="lazy"
                                                        alt={obj.name}
                                                    />
                                                </Link>
